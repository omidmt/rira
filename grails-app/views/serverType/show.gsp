...
<div class="container">
	...
	<div id="show-serverType" class="content scaffold-show" role="main">
			...
			<g:if test="${serverTypeInstance?.name}">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<p class="form-control-static disabled" aria-labelledby="name-label"><g:fieldValue bean="${serverTypeInstance}" field="name"/></p>
		...
		<g:form url="[resource:serverTypeInstance, action:'delete']" method="DELETE">
			<div class="btn-group">
				<fieldset class="form-group">
					<g:link class="edit btn btn-default" action="edit" resource="${serverTypeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
