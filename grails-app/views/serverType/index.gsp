...
<html>
    ...
    <div class="container">
		...
		<div id="list-serverType" class="content scaffold-list" role="main">
				...
				<g:each in="${serverTypeInstanceList}" status="i" var="serverTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td class="text-center">
							<g:link action="clone" role="button" resource="${serverTypeInstance}" data-toggle="tooltip" title="Clone" class="btn btn-info"><span class="glyphicon glyphicon-copy"></span></g:link>
						</td>
			...
			<ul class="pagination">
				<g:paginate total="${serverTypeInstanceCount ?: 0}" />
			</ul>
		</div>
    </div>
	</body>
