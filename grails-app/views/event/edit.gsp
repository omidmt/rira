...
<html>
    ...
    <div class="container">
		...
		<div id="edit-event" class="content scaffold-edit" role="main">
			...
			<g:form id="eventInstance" url="[resource:eventInstance, action:'update']" method="PUT" class="form-horizontal" role="form" >
				<g:hiddenField name="version" value="${eventInstance?.version}" />
					<g:render template="form"/>
					<g:actionSubmit class="save" form="eventInstance" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
			</g:form>
		</div>
    </div>
	</body>
