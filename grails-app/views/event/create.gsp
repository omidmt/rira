...
<html>
    ...
    <div class="container">
		...
		<div id="create-event" class="content scaffold-create" role="main">
			...
			<g:form id="eventInstance" url="[resource:eventInstance, action:'save']"  class="form-horizontal" role="form" >
					<g:render template="form"/>
					<g:submitButton name="create" form="eventInstance" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
			</g:form>
		</div>
    </div>
	</body>
