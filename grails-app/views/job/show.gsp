			...
			%{--<li class="fieldcontain">--}%
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<p class="form-control-static disabled" aria-labelledby="log-label"><g:fieldValue bean="${jobInstance}" field="log"/></p>
			...
			%{--<li class="fieldcontain">--}%
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<p id="status" class="form-control-static disabled" aria-labelledby="status-label"><g:fieldValue bean="${jobInstance}" field="status"/></p>
