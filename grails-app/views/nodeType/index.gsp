...
<html>
    ...
    <div class="container">
		...
		<div id="list-nodeType" class="content scaffold-list" role="main">
				...
				<g:each in="${nodeTypeInstanceList}" status="i" var="nodeTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td class="text-center">
							<g:link action="clone" role="button" resource="${nodeTypeInstance}" data-toggle="tooltip" title="Clone" class="btn btn-info"><span class="glyphicon glyphicon-copy"></span></g:link>
						</td>
			...
			<ul class="pagination">
				<g:paginate total="${nodeTypeInstanceCount ?: 0}" />
			</ul>
		</div>
    </div>
	</body>
