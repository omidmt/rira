    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">%{-- centerMrgn--}%
                %{--<button type="button" class="" data-toggle="collapse" data-target="#navbar-collapse-01">--}%
                    %{--<span class="sr-only">Toggle navigation</span>--}%
                %{--</button>--}%
                %{--<button type="button" class="navbar-toggle" data-autohide="false" data-toggle="offcanvas" data-recalc="false" data-target="#navmenu" data-canvas="#canvas">--}%
