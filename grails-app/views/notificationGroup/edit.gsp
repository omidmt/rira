...
<html>
	...
	<body>
    <div class="container">
		%{--<a href="#edit-notificationGroup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
        <div class="navbar">
            <div class="nav">
		...
		<div id="edit-notificationGroup" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:notificationGroupInstance, action:'update']" method="PUT" >
